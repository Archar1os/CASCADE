...
<html lang="en">
	<head>
		...
		<!-- P FONT FOR MENU2ND -->
		<link
			href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Cinzel:wght@400..900&display=swap"
			rel="stylesheet"
		/>
	...
	<body>
		<div class="banner">
			...
			<div class="background_fixed">
				<img
					src="assets/img/menu2nd background.gif"
		...
		<div class="best-sellers">
			<div class="menu2-item">
				<h3>Meow-Nat</h3>
				<p>Our adorable cat-shaped donut!</p>
				<p class="price">P59</p>
			</div>
			<div class="menu2-item">
				<h3>Cloud Cake</h3>
				<p>
					Fluffy layers of our cloud cake, a heavenly chocolate treat
			...
			<div class="menu2-item">
				<h3>Cafe-Chino</h3>
				<p>
					Sip into perfection with our Cafe-Chino, a smooth and creamy
					cappuccino that’s just right.
				</p>
				<p class="price">₱ 109</p>
			</div>
			<div class="menu2-item">
				<h3>Mel-Drizle</h3>
				<p>
					Enjoy the rich, buttery sweetness of our Mel-Drizzle! A
					perfect caramel touch to elevate your coffee or dessert.
				</p>
				<p class="price">P109</p>
			</div>
		</div>
		...
		<section class="coffee" id="coffee-section">
			...
			<div class="coffee-items">
				<div class="item">
					<h3>AMERICANO</h3>
					<p>
						Simple, bold, and classic. Our Americano is a smooth
						black coffee that delivers rich flavor with every sip.
					</p>
					<p>₱99</p>
				</div>
				<div class="item">
					...
					<p>
						A rich, buttery caramel flavor with a hint of sea salt
						for a delicious twist on your favorite treat!
					</p>
					<p>₱129</p>
				</div>
				<div class="item">
					<h3>CARAMEL CHOCO</h3>
					<p>
						A perfect blend of bold coffee and smooth chocolate.
						Every sip is a delicious mix of rich flavors!
					</p>
					<p>₱119</p>
				</div>
			</div>
		...
		<section class="coffee" id="matcha-section">
			...
			<div class="coffee-items">
				<div class="item">
					<h3>MACHA FOAM</h3>
					<p>
						Smooth matcha topped with creamy foam—light, flavorful,
						and refreshing!
					</p>
					<p>₱129</p>
				</div>
				<div class="item">
					<h3>MACHA CHINO</h3>
					<p>
						A frothy, creamy matcha drink, just like a cappuccino.
						Warm and delicious!
					</p>
					<p>₱109</p>
				</div>
		...
		<section class="coffee" id="FD-section">
			...
			<div class="coffee-items">
				<div class="item">
					<h3>BERRY-BATH</h3>
					<p>
						Dive into the refreshing taste of Berry Bath—a bubbly
						mix of sweet strawberry and soda for a fruity, fizzy
						delight!
					</p>
					<p>₱139</p>
				</div>
				<div class="item">
					<h3>BLUE WINTER</h3>
					<p>
						Chill out with Blue Winter—a refreshing blend of zesty
						lemonade and soda with a cool blue twist!
					</p>
					<p>₱139</p>
				</div>
				<div class="item">
					<h3>JUNGLE'S BASE</h3>
					<p>
						Cool off with Jungle's Base—an irresistible avocado
						shake that's creamy, smooth, and refreshingly unique!
					</p>
					<p>₱139</p>
				</div>
			</div>
		...
		<section class="coffee" id="snacks-section">
			...
			<div class="coffee-items">
				<div class="item">
					<h3>HEAVY BFAST</h3>
					<p>
						Start your day with Heavy Bfast—a thick, fluffy pancake
						drizzled with rich chocolate syrup.
					</p>
					<p>₱139</p>
				</div>
				<div class="item">
					<h3>CHEESY TATOES BALLS</h3>
					<p>
						Crispy, gooey cheesy potato balls—pure deliciousness in
						every bite!
					</p>
					<p>₱99</p>
				</div>
